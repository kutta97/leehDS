...
Sets::Sets(int numberOfElements) {
	...
	n = numberOfElements; parent = new int[n];
...
bool GetEdge( const int numnodes, Edge& e) {
	// make sure that node number is 0 to NNODES-1
	
	if (cin >> e.v1) { cin >> e.v2 >> e.weight; }
	else { return false; }
	if (e.v1 < 0 || e.v1 >= numnodes
		|| e.v2 < 0 || e.v2 >= numnodes || e.v1 == e.v2)
